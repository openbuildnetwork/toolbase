import { GeneratorOptions, Language } from "@/types/json-to-interface-types";
export function generateModels(json: any, options: GeneratorOptions): string {
    ...
    function processValue(name: string, value: any): string {
        if (value === null) {
            switch (language) {
        ...
        if (typeof value === 'object' && value !== null) {
            ...
            if (!models.has(className)) {
                ...
                const modelContent = generateModelContent(className, value, language, usePydantic);
    ...
    function getBaseType(val: any, lang: Language): string {
    ...
    function generateModelContent(name: string, obj: any, lang: Language, pydantic: boolean): string {
