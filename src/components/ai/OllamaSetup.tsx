        ...
        <CardContent className="space-y-6 pt-4">
          <div className="space-y-4">
            <div className="flex gap-4">
              <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-(--surface-secondary) text-sm font-medium text-(--text-secondary)">
                1
              </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="w-full space-y-1">
                ...
                <div className="mt-2 flex w-full items-center overflow-hidden rounded-lg bg-(--surface-secondary) px-4 py-3 text-sm text-(--text-primary) border border-(--border-subtle)">
                  <Terminal className="mr-2 h-4 w-4 shrink-0 text-(--text-muted)" />
  ...
  return (
    <Card className="w-full max-w-md mx-auto">
      ...
      <CardContent className="space-y-6 pt-0">
        <div className="space-y-2">
          <div className="mt-2 flex items-center rounded-lg bg-(--surface-secondary) px-4 py-3 text-sm text-(--text-primary) border border-(--border-subtle)">
            <Terminal className="mr-2 h-4 w-4 shrink-0 text-(--text-muted)" />
