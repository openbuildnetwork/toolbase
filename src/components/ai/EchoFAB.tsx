...
export function EchoFAB() {
  const { isOpen, toggleChat, isGenerating, isLoading, isLoaded, progressPercentage } = useAIChat();
    ...
    <AnimatePresence>
      {!isOpen && (
        <motion.button
          ...
          onClick={toggleChat}
          className={cn(
            "fixed bottom-6 right-6 z-[90] flex h-14 w-14 items-center justify-center rounded-full shadow-2xl transition-all duration-300",
