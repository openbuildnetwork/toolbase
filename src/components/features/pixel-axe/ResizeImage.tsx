...
export function ResizeImage() {
    ...
    const handlePresetSelect = (presetId: string) => {
        ...
        if (preset) {
            ...
            // Pixel Axe plain resize creates stretch if AR doesn't match.
                    ...
                    <div className="p-1.5 bg-white rounded-[32px] shadow-2xl shadow-gray-200/50 border border-gray-100 relative">
                        ...
                        <FileDropZone
                            ...
                            className={cn(
                                ...
                                isReady ? "hover:bg-cyan-50/50 hover:border-cyan-200 cursor-pointer" : "cursor-wait opacity-50"
                            )}
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        ...
                        <div className="bg-slate-900 rounded-[24px] p-5 shadow-2xl shadow-slate-900/20 text-white space-y-4">
                            ...
                            <Button
                                ...
                                className="w-full bg-cyan-600 hover:bg-cyan-500 text-white rounded-xl h-12 font-bold shadow-lg shadow-cyan-900/20 border-0 mb-3"
