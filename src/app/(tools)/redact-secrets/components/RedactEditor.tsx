...
import { ContentType } from "@/app/(tools)/redact-secrets/types/redact";
...
interface RedactEditorProps {
    ...
    saveToNoteVault: (title: string, data: string, addNote: (note: Note) => Promise<void>) => Promise<void>;
}
...
export const RedactEditor: React.FC<RedactEditorProps> = ({
    ...
    const handleImportFromVault = (note: Note) => {
                                ...
                                {fileName ? (
                                    <div className="space-y-2">
                                        ...
                                        <button 
                                            onClick={(e) => {
                                                e.stopPropagation();
                                                onFileUpload({ target: { files: null } } as unknown as React.ChangeEvent<HTMLInputElement>);
                                            }}
