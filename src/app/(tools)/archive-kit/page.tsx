                    ...
                    {telemetry.length > 0 && (
                      <div className="rounded-xl border border-gray-200 bg-gray-50/60 p-4">
                        <div className="flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-2">
                            <label className="text-xs text-gray-600 flex items-center gap-1 relative group">
                              <input
                                type="checkbox"
                  ...
                  <>
                    ...
                    {inspectEntries.length > 0 && (
                      <div className="grid sm:grid-cols-4 gap-2">
                        ...
                        <div className="rounded-lg border border-gray-200 bg-white px-3 py-2 text-xs text-gray-600 sm:col-span-4 flex items-center justify-between">
                          <div>
                        ...
                        {filteredInspectEntries.length === 0 ? (
                          ...
                          filteredInspectEntries.map((entry) => (
                            ...
                            >
                              ...
                              <div className="col-span-2 text-right text-gray-600 whitespace-nowrap overflow-hidden text-ellipsis">{bytesToHuman(entry.size)}</div>
                              <div className="col-span-2 text-right text-gray-600 whitespace-nowrap overflow-hidden text-ellipsis">{bytesToHuman(entry.compressedSize)}</div>
                    ...
                    {previewPath && (
                      <div className="rounded-xl border border-gray-200 bg-gray-50/60 p-4 space-y-2">
                        ...
                        {previewError ? (
                          ...
                          <pre className="max-h-[260px] overflow-auto rounded-lg border border-gray-200 bg-white p-3 text-xs text-gray-700 whitespace-pre-wrap font-mono">
