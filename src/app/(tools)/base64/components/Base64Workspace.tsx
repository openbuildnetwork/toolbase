...
import { useBase64 } from '@/app/(tools)/base64/hooks/useBase64Worker';
                                                ...
                                                <div className="p-4 bg-(--surface-secondary)/50 rounded-xl border border-(--border-subtle) flex flex-col items-center">
                                                    ...
                                                    <div className="relative group/img w-full flex justify-center">
                                                        <Image 
                                                            ...
                                                            height={600}
                                                            unoptimized
                                                            className="max-h-64 w-auto rounded-lg shadow-2xl object-contain transition-transform group-hover/img:scale-[1.02]" 
                                                        />
                            ...
                            {error ? (
                                ...
                                decodedImageUrl ? (
                                    <div className="p-8 h-full overflow-auto flex flex-col items-center custom-scrollbar">
                                        ...
                                        <div className="relative group/res mt-auto mb-auto w-full flex justify-center">
                                            <Image 
                                                src={decodedImageUrl} 
                                                alt="Decoded" 
                                                width={1200}
                                                height={800}
                                                unoptimized
                                                className="max-w-full max-h-[400px] w-auto rounded-xl shadow-2xl border border-(--border-subtle) object-contain transition-transform group-hover/res:scale-[1.02]" 
                                            />
