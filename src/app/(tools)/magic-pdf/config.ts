  ...
  tip: [
    ...
    },
    {
      ...
      getInteractionComponent: async () => {
        const { default: SplitPdf } = await import('@/app/(tools)/magic-pdf/components/SplitPdf');
        return SplitPdf;
      },
      getExecutor: async () => {
        const { createPerPayloadTIPExecutor } = await import('@/tip/executor');
    ...
    },
    {
      ...
      interactable: true as const,
      getInteractionComponent: async () => {
        const { default: MergePdf } = await import('@/app/(tools)/magic-pdf/components/MergePdf');
        return MergePdf;
      },
      getExecutor: async () => {
    ...
    },
    {
      ...
      interactable: true as const,
      getInteractionComponent: async () => {
        const { default: RearrangePdf } = await import('@/app/(tools)/magic-pdf/components/RearrangePdf');
        return RearrangePdf;
      },
      ...
      getExecutor: async () => {
        return async (input: import('@/tip/protocol').TIPBundle, config: import('@/tip/protocol').TIPConfig) => {
          const { rearrangePdf } = await import('@/app/(tools)/magic-pdf/lib/pdf-actions');
          ...
          const resultFile = new File([resultBytes as unknown as BlobPart], `rearranged_${payload.meta.filename ?? 'output.pdf'}`, { type: 'application/pdf' });
    ...
    },
    {
      ...
      interactable: true as const,
      getInteractionComponent: async () => {
        const { default: UnlockPdf } = await import('@/app/(tools)/magic-pdf/components/UnlockPdf');
        return UnlockPdf;
      },
    },
    {
      ...
      interactable: true as const,
      getInteractionComponent: async () => {
        const { default: MaskPdf } = await import('@/app/(tools)/magic-pdf/components/MaskPdf');
        return MaskPdf;
      },
      getExecutor: async () => {
        const { createPerPayloadTIPExecutor } = await import('@/tip/executor');
        ...
        return createPerPayloadTIPExecutor(
          ...
          (b, c) => ({
            file_bytes: b,
            edits: (c.edits as Record<string, unknown>[])?.map(el => ({
              ...el,
            })) || []
          }),
          () => 'application/pdf',
    ...
    },
    {
      ...
      interactable: true as const,
      getInteractionComponent: async () => {
        const { default: SignPdf } = await import('@/app/(tools)/magic-pdf/components/SignPdf');
        return SignPdf;
      },
      // Pure pdf-lib executor — no Python WASM needed
      getExecutor: async () => {
        return async (input: import('@/tip/protocol').TIPBundle, config: import('@/tip/protocol').TIPConfig) => {
          ...
          const resultFile = new File(
            [finalBytes as unknown as BlobPart],
