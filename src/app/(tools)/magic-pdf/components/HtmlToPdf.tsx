...
export default function HtmlToPdf() {
    ...
    const { execute, isProcessing, progressMessage } = useTIPTool('magic-pdf/html-to-pdf');
    ...
    const handleConvert = async () => {
        ...
        try {
            ...
            setIsFetching(false);
            alert('Failed to convert HTML to PDF: ' + (error instanceof Error ? error.message : String(error)));
        }
    };
