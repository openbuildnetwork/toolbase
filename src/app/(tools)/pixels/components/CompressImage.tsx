...
import { CompressionSettings } from "@/app/(tools)/pixels/components/CompressionSettings";
...
export function CompressImage() {
    ...
    const { execute, isProcessing, tool } = useTIPTool('pixels/compress');
    ...
    const handleCompress = async () => {
        ...
        try {
            const resultFiles = await execute([originalFile], config as Record<string, string | number | boolean>);
                            ...
                            <div className="flex justify-between items-center opacity-80 text-sm font-medium">
                                ...
                                {compressedInfo && (
                                    <span className="font-mono text-emerald-500">
                                        {formatBytes(compressedInfo.size_bytes || 0)}
                                    </span>
                                )}
                            </div>
                            <Button
