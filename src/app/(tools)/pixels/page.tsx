...
const ResizeImage = dynamic(() => import("@/app/(tools)/pixels/components/ResizeImage").then(mod => mod.ResizeImage), { ssr: false, loading: () => <div className="animate-pulse h-64 bg-surface-secondary rounded-2xl" /> });
